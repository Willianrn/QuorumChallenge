...
export default function Home() {
  const [activeTab, setActiveTab] = React.useState<string>("legislators");
    ...
    <div className="min-h-full">
              ...
              <div className="hidden md:block">
                <div className="ml-10 flex items-baseline space-x-4">
                  ...
                  <a
                    ...
                    className={activeTab === "legislators" ? activeLink : inactiveLink}
                    aria-current="page"
                  >
                    Legislator Data
                  </a>
                  <a
                    ...
                    className={activeTab === "bills" ? activeLink : inactiveLink}
                  >
                    Bill Data
                  </a>
                </div>
      ...
      <main>
        <div className="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
          {activeTab === "legislators" ? <LegislatorsTable /> : <BillsTable />}
        </div>
      </main>
    </div>
  );
